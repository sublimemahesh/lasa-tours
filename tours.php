...
<html lang="en">
    ...
    <head>
        ...
        <!-- PAGE TITLE -->
        <title> Tours - <?php echo $TOUR_TYPES->name ?> | Sri Lanka Lasa Tours</title>
        <!-- BOOTSTRAP CSS -->
 ...
 <script             type="text/j                        avascript">
                    ...
                    new google.translate.TranslateElement({pageLanguage: 'en', autoDisplay: false}, 'google_translate_element'); //remove            the layou                    t
        }
                          </script>
                <script src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit" type="text/javascript"></script>
