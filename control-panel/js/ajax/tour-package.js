$(document).ready(function () {
    ...
    $("#create").click(function (event) {
        ...
        if (!$('#tour_type').val() || $('#tour_type').val().length === 0) {
            swal({
                title: "Error!",
            ...
            $.ajax({
                url: "post-and-get/tour-package.php",
                type: "POST",
                data: formData,
                async: false,
                dataType: 'json',
                success: function (result) {
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("./view-tour-date.php?id=" + result.id);
                        }, 1500);
                    });
                },
                cache: false,
            ...
            $.ajax({
                ...
                success: function (result) {
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("edit-tour-package.php?id=" + result.id);
                        }, 1500);
                    });
                },
                cache: false,
